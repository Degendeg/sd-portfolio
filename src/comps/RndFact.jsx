...
const RndFact = ({ itemsRef, isDark, ReactTyped }) => {
  ...
  const randomFacts = [
    { header: 'Cat Owner', text: '🐱🐈 My cat is named Elda and she came to me a few weeks old back in 2016. She is just a farmers cat but a loved family member, see <a>image here</a>.' },
    ...
    { header: 'Gamer', text: '🖥️🎮 I have been playing video games since childhood. The Sims, Warcraft, C&C, Sudden Strike, CS, WoW, DotA 2, RL, The Long Dark, etc..' },
    ...
    { header: 'Favorite Movies', text: '🎥🎞️ It is difficult to choose just one favorite movie, so I will mention several.. including Star Wars (4,5,6), Gladiator, Goodfellas, Shawshank Redemption, and Interstellar.' },
